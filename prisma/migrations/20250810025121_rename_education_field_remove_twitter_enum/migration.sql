/*
  ...
  - The values [TWITTER] on the enum `ContactType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."ContactType_new" AS ENUM ('EMAIL', 'PHONE', 'WEBSITE', 'X', 'LINKEDIN', 'GITHUB', 'DISCORD', 'LINK');
