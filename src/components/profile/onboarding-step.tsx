	...
	return (
		...
		>
			<DialogHeader>
				...
				<DialogDescription>
					Just a few more things before we can get you started. You&apos;ll be
					able to change these later.
				</DialogDescription>
			</DialogHeader>
			<Form {...profileForm}>
							...
							<FormItem>
								...
								<FormControl>
									<div className="relative">
										...
										/>
										<AnimatePresence>
											{fieldState.error && nameValue.trim().length > 0 && (
												<motion.span
													key="name-error"
											...
											{nameValue.trim().length > 0 && !fieldState.error && (
												<motion.span
													key="name-success"
													initial={{ opacity: 0, y: 10 }}
													animate={{ opacity: 1, y: 0 }}
